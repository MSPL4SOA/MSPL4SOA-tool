...
public class Composers_rest_ServiceName_3 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_3_3")) {
			...
			in.setInputName_3_3_5((String) source.getParameters()[5]);
			in.setInputName_3_3_6((String) source.getParameters()[6]);
			in.setInputName_3_3_3((Integer) source.getParameters()[7]);
		...
		if (opName.equals("CapabilityName_3_5")) {
			...
			in.setInputName_3_5_7((Float) source.getParameters()[0]);
			in.setInputName_3_5_8((Float) source.getParameters()[1]);
			in.setInputName_3_5_5((Float) source.getParameters()[2]);
			in.setInputName_3_5_6((Integer) source.getParameters()[3]);
			in.setInputName_3_5_3((Float) source.getParameters()[4]);
			in.setInputName_3_5_4((Float) source.getParameters()[5]);
			in.setInputName_3_5_1((Integer) source.getParameters()[6]);
			in.setInputName_3_5_2((Float) source.getParameters()[7]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_1")) {
			...
			in.setInputName_3_1_9((String) source.getParameters()[4]);
			in.setInputName_3_1_7((String) source.getParameters()[5]);
			in.setInputName_3_1_8((String) source.getParameters()[6]);
			in.setInputName_3_1_5((Float) source.getParameters()[7]);
			in.setInputName_3_1_6((String) source.getParameters()[8]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_2")) {
			...
			in.setInputName_3_2_1((Float) source.getParameters()[1]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_3_CapabilityName_3_3 = (State_ServiceName_3_CapabilityName_3_3) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_3_CapabilityName_3_3");
		...
		instanceState_ServiceName_3_CapabilityName_3_4 = (State_ServiceName_3_CapabilityName_3_4) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_3_CapabilityName_3_4");
		...
		instanceState_ServiceName_3_CapabilityName_3_5 = (State_ServiceName_3_CapabilityName_3_5) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_3_CapabilityName_3_5");
		...
		instanceState_ServiceName_3_CapabilityName_3_2 = (State_ServiceName_3_CapabilityName_3_2) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_3_CapabilityName_3_2");
