...
public class Composers_rest_ServiceName_4 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_4_2")) {
			...
			in.setInputName_4_2_2((Integer) source.getParameters()[1]);
		...
		if (opName.equals("CapabilityName_4_3")) {
			...
			in.setInputName_4_3_1((Integer) source.getParameters()[2]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_4")) {
			...
			in.setInputName_4_4_1((Integer) source.getParameters()[2]);
			in.setInputName_4_4_2((Integer) source.getParameters()[3]);
			in.setInputName_4_4_3((String) source.getParameters()[4]);
			in.setInputName_4_4_4((Float) source.getParameters()[5]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_5")) {
			...
			in.setInputName_4_5_3((Integer) source.getParameters()[2]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_1")) {
			...
			in.setInputName_4_1_6((Integer) source.getParameters()[2]);
