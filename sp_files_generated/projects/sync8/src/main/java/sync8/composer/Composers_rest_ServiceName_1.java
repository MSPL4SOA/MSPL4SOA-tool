...
public class Composers_rest_ServiceName_1 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_1_5")) {
			...
			in.setInputName_1_5_3((String) source.getParameters()[2]);
			in.setInputName_1_5_4((String) source.getParameters()[3]);
			in.setInputName_1_5_1((Float) source.getParameters()[4]);
			in.setInputName_1_5_2((String) source.getParameters()[5]);
		...
		if (opName.equals("CapabilityName_1_6")) {
			...
			in.setInputName_1_6_2((Float) source.getParameters()[1]);
			in.setInputName_1_6_3((Integer) source.getParameters()[2]);
			in.setInputName_1_6_1((String) source.getParameters()[3]);
			message.setContent(in);
		}
