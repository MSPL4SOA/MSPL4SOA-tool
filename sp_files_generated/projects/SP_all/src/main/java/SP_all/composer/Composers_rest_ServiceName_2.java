...
public class Composers_rest_ServiceName_2 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_2_5")) {
			...
			in.setInputName_2_5_6((Integer) source.getParameters()[5]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_2_1")) {
			...
			in.setInputName_2_1_7((Float) source.getParameters()[6]);
			in.setInputName_2_1_8((Integer) source.getParameters()[7]);
			in.setInputName_2_1_9((Integer) source.getParameters()[8]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_2_2")) {
			...
			in.setInputName_2_2_6((String) source.getParameters()[5]);
		...
		if (opName.equals("CapabilityName_2_3")) {
			...
			in.setInputName_2_3_4((String) source.getParameters()[3]);
			in.setInputName_2_3_5((Integer) source.getParameters()[4]);
			in.setInputName_2_3_6((Float) source.getParameters()[5]);
			in.setInputName_2_3_7((Integer) source.getParameters()[6]);
			in.setInputName_2_3_8((Integer) source.getParameters()[7]);
			message.setContent(in);
		}
