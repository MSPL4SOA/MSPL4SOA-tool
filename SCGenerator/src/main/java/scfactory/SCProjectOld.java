...
public class SCProjectOld {
	...
	public static void main(String args[]) {
		try {
			SCProject scProject = new SCProject("http://localhost:8080/SP_helicopter1");
	...
	public SCProjectOld(String host) {
	...
	public void downloadFiles() {
		...
		String responseString = target.path("DownloadContract/" + FM_SC_UPDATE_FML_NAME).request().method("GET")
				.readEntity(String.class);
...
//		System.out.println(fmSCUpdateFML_eq_);
		...
		try {
			fmvFMSCUpdate = FMBDD.getInstance().FM("fmscupdate", fmSCUpdateFML_eq_);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
