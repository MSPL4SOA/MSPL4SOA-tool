 ...
 * 2016-08-19T15:34:24.282+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_2", wsdlLocation = "http://localhost:8080/v2/ServiceName_2/ServiceName_2?wsdl", targetNamespace = "urn:v2:v2:1.0")
public class ServiceName2 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName("urn:v2:v2:1.0",
			"ServiceName_2");
	public final static QName ServiceName2Port = new QName("urn:v2:v2:1.0",
			"ServiceName_2Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/v2/ServiceName_2/ServiceName_2?wsdl");
