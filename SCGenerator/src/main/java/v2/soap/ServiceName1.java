 ...
 * 2016-08-19T15:34:24.144+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_1", wsdlLocation = "http://localhost:8080/v2/ServiceName_1/ServiceName_1?wsdl", targetNamespace = "urn:v2:v2:1.0")
public class ServiceName1 extends Service {
	...
	public final static QName SERVICE = new QName("urn:v2:v2:1.0",
			"ServiceName_1");
	public final static QName ServiceName1Port = new QName("urn:v2:v2:1.0",
			"ServiceName_1Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/v2/ServiceName_1/ServiceName_1?wsdl");
