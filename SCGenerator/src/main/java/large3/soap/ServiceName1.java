 ...
 * 2016-09-15T23:29:47.385+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_1", wsdlLocation = "http://localhost:8080/large3/ServiceName_1/ServiceName_1?wsdl", targetNamespace = "urn:large3:large3:1.0")
public class ServiceName1 extends Service {
	...
	public final static QName ServiceName1Port = new QName(
			"urn:large3:large3:1.0", "ServiceName_1Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/large3/ServiceName_1/ServiceName_1?wsdl");
