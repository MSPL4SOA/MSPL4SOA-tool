...
public class FMStatistics {
	...
	public static void stat1() throws Exception {
		...
		String projectDir = "";
//				MainGui.projectsFilesGeneratedPath + projectName + "/fm_familiar_generated/";
		...
		String internalFeaturesSPPath = filesDir + "internal_features_sc.txt";
