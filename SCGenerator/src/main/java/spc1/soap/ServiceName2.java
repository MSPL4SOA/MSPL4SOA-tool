 ...
 * 2016-09-14T19:47:20.715+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_2", wsdlLocation = "http://localhost:8080/spc1/ServiceName_2/ServiceName_2?wsdl", targetNamespace = "urn:spc1:spc1:1.0")
public class ServiceName2 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName("urn:spc1:spc1:1.0",
			"ServiceName_2");
	public final static QName ServiceName2Port = new QName("urn:spc1:spc1:1.0",
			"ServiceName_2Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/spc1/ServiceName_2/ServiceName_2?wsdl");
