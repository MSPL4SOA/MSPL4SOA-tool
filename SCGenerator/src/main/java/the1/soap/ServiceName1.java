 ...
 * 2017-03-20T16:37:08.428+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_1", wsdlLocation = "http://localhost:8080/the1/ServiceName_1/ServiceName_1?wsdl", targetNamespace = "urn:the1:the1:1.0")
public class ServiceName1 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName("urn:the1:the1:1.0",
			"ServiceName_1");
	public final static QName ServiceName1Port = new QName("urn:the1:the1:1.0",
			"ServiceName_1Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/the1/ServiceName_1/ServiceName_1?wsdl");
