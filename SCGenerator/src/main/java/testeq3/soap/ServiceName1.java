 ...
 * 2016-09-15T21:24:54.579+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_1", wsdlLocation = "http://localhost:8080/testeq3/ServiceName_1/ServiceName_1?wsdl", targetNamespace = "urn:testeq3:testeq3:1.0")
public class ServiceName1 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName("urn:testeq3:testeq3:1.0",
			"ServiceName_1");
	public final static QName ServiceName1Port = new QName(
			"urn:testeq3:testeq3:1.0", "ServiceName_1Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/testeq3/ServiceName_1/ServiceName_1?wsdl");
