 ...
 * generated in the testeq3.soap package. 
...
public class ObjectFactory {
	...
	private final static QName _InputDataClassName_1_1_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "InputDataClassName_1_1");
	private final static QName _InputDataClassName_1_2_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "InputDataClassName_1_2");
	private final static QName _OutputDataClassName_1_1_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "OutputDataClassName_1_1");
	private final static QName _OutputDataClassName_1_2_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "OutputDataClassName_1_2");
	private final static QName _CapabilityName_1_1_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "CapabilityName_1_1");
	private final static QName _CapabilityName_1_1Response_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "CapabilityName_1_1Response");
	private final static QName _CapabilityName_1_2_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "CapabilityName_1_2");
	private final static QName _CapabilityName_1_2Response_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "CapabilityName_1_2Response");
	private final static QName _CapabilityName_1_3_QNAME = new QName(
			"urn:testeq3:testeq3:1.0", "CapabilityName_1_3");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: testeq3.soap
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "InputDataClassName_1_1")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "InputDataClassName_1_2")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "OutputDataClassName_1_1")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "OutputDataClassName_1_2")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "CapabilityName_1_1")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "CapabilityName_1_1Response")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "CapabilityName_1_2")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "CapabilityName_1_2Response")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "urn:testeq3:testeq3:1.0", name = "CapabilityName_1_3")
