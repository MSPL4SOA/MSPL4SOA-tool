...
public class Functions {
	...
	public static void mkdirIfExist(String fileInPath) {
		// fileInPath.replaceAll(".", "/");
	...
	public static int getFileLinesCount(String myfilePath) {
		...
		Process process;
		String[] cmdArgs = { "/bin/sh", "-c", "wc -l " + myfilePath + " | cut -d' ' -f1" };
	...
	public static int getFileLinesCount2(String myfilePath) {
		...
		try {
			is = new InputStreamReader(new FileInputStream(myfilePath), "UTF-8");
	...
	public static String deleteExtension(String myString) {
		...
		if (pointIndex != -1) {
			return myString.substring(0, pointIndex);
		} else {
			return myString;
		}
	}
	...
	public static ArrayList<ArrayList<String>> fileToLists(File textFile, String delim) {
		...
		try {
			is = new InputStreamReader(new FileInputStream(textFile), "UTF-8");
			br = new BufferedReader(is);
	...
	public static String fileToString(String textFilePath) {
	...
	public static ArrayList<String> StringToList(String line, String delim) {
	...
	public static void splitFile(String fileInPath, String fileOutPath, int firstLine, int lastLine) {
		...
		try {
			is = new InputStreamReader(new FileInputStream(fileInPath), "UTF-8");
			br = new BufferedReader(is);

			os = new OutputStreamWriter(new FileOutputStream(fileOutPath), "UTF-8");
			bw = new BufferedWriter(os);
	...
	public static void stringToFile(String line, String fileOutPath, boolean append) {
		...
		try {
			os = new OutputStreamWriter(new FileOutputStream(fileOut, append), "UTF-8");
			bw = new BufferedWriter(os);
	...
	public static void stringListToFile(ArrayList<String> listIn, String fileOutPath, boolean append) {
		File fileOut = new File(fileOutPath);
	...
	public static void delWords(String filePath, int wordsDelCount, String fileOutPath) {
		InputStreamReader is;
		BufferedReader br;
	...
	public static void serializeObject(Object objet, String outFilePath) {
		try {
	...
	static public String toLowerFirstLetter(String in) {
