...
public class FMStatistics3 {
	...
	public static void stat1() throws Exception {
		...
		System.out.println("AMs :: " + FMBDD.getInstance()
				.FM("fm_sp", FMFactory.reduceComplexitySP(deleteAttributesValues(Functions.fileToString(fmSPPath))))
		...
		System.out.println("Internal Features :: " + fmStatistics(fmSPSpecializeSyncPath, internalFeaturesSPPath));
		System.out.println("Essential Features :: " + fmStatistics(fmSPSpecializeSyncPath, essentialFeaturesPath));
		System.out.println("Specialized Features :: " + fmStatistics(fmSPSpecializeSyncPath, specializedFeaturesPath));
		System.out.println("AMs :: " + FMBDD.getInstance()
				.FM("fm_spd",
		...
		System.out.println("AMs :: " + FMBDD.getInstance()
				.FM("fm_sc", FMFactory.reduceComplexitySP(deleteAttributesValues(Functions.fileToString(fmSCPath))))
				.counting(CountingStrategy.SAT_FML) / 2);
		System.out.println("-------------------------");
		...
		System.out.println("AMs :: "
				+ FMBDD.getInstance().FM("fm_sc_update", fmSPspecReduceComplexity).counting(CountingStrategy.SAT_FML)
						/ 2);
		System.out.println("-------------------------");
	}
