...
public class FMStatistics2 {
	...
	public static void stat1() throws Exception {
		...
		// + FMBDD.getInstance().FM("fm_sp",
		// Functions.fileToString(fmSPPath)).counting(CountingStrategy.SAT_FML)
		// / 2);
		// System.out.println("-------------------------");
		//
		// // SP specialize
		...
		// .FM("fm_sp",
		// Functions.fileToString(fmSPSpecializePath).replaceAll("=",
		// EQ_ATTRIBUTE))
		// .counting(CountingStrategy.SAT_FML) / 2);
		// System.out.println("-------------------------");
		//
		...
		// System.out.println("AMs :: "
		// + FMBDD.getInstance().FM("fm_sc",
		// Functions.fileToString(fmSCPath)).counting(CountingStrategy.SAT_FML)
		// / 2);
		// System.out.println("-------------------------");
		...
		String fmSPspecReduceComplexity = FMFactory.reduceComplexitySP(
				deleteAttributesValues(Functions.fileToString(fmSCUpdatePath).replaceAll("=", EQ_ATTRIBUTE)));
		;
		System.out.println("AMs :: "
