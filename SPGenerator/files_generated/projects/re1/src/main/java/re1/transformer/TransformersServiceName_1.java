...
public final class TransformersServiceName_1 {
	...
	@Transformer(to = "{urn:re1:re1:1.0}CapabilityName_1_1Response")
	public Element transformOutputDataClassName_1_1ToCapabilityName_1_1Response(
			OutputDataClassName_1_1 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_1:CapabilityName_1_1Response xmlns:OutputDataClassName_1_1=\"urn:re1:re1:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:re1:re1:1.0}CapabilityName_1_1")
	...
	@Transformer(to = "{urn:re1:re1:1.0}CapabilityName_1_2Response")
	public Element transformOutputDataClassName_1_2ToCapabilityName_1_2Response(
			OutputDataClassName_1_2 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_2:CapabilityName_1_2Response xmlns:OutputDataClassName_1_2=\"urn:re1:re1:1.0\">")
				.append("<return>")
