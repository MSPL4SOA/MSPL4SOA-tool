...
public class Composers_rest_ServiceName_5 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_5_5")) {
			...
			in.setInputName_5_5_3((Integer) source.getParameters()[2]);
			in.setInputName_5_5_4((String) source.getParameters()[3]);
		...
		if (opName.equals("CapabilityName_5_6")) {
			...
			in.setInputName_5_6_2((Float) source.getParameters()[2]);
			in.setInputName_5_6_3((Integer) source.getParameters()[3]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_1")) {
			...
			in.setInputName_5_1_3((Integer) source.getParameters()[3]);
			in.setInputName_5_1_4((Integer) source.getParameters()[4]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_2")) {
			...
			in.setInputName_5_2_2((Float) source.getParameters()[3]);
			in.setInputName_5_2_3((String) source.getParameters()[4]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_3")) {
			...
			in.setInputName_5_3_3((String) source.getParameters()[0]);
			in.setInputName_5_3_4((Float) source.getParameters()[1]);
			in.setInputName_5_3_1((String) source.getParameters()[2]);
			in.setInputName_5_3_2((Integer) source.getParameters()[3]);
			in.setInputName_5_3_5((Float) source.getParameters()[4]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_4")) {
			...
			in.setInputName_5_4_2((String) source.getParameters()[0]);
			in.setInputName_5_4_3((Float) source.getParameters()[1]);
			in.setInputName_5_4_1((Float) source.getParameters()[2]);
			in.setInputName_5_4_4((Float) source.getParameters()[3]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_5_CapabilityName_5_5 = (State_ServiceName_5_CapabilityName_5_5) ctx
				.lookup("java:global/large2/State_ServiceName_5_CapabilityName_5_5");
		...
		instanceState_ServiceName_5_CapabilityName_5_6 = (State_ServiceName_5_CapabilityName_5_6) ctx
				.lookup("java:global/large2/State_ServiceName_5_CapabilityName_5_6");
		...
		instanceState_ServiceName_5_CapabilityName_5_1 = (State_ServiceName_5_CapabilityName_5_1) ctx
				.lookup("java:global/large2/State_ServiceName_5_CapabilityName_5_1");
		...
		instanceState_ServiceName_5_CapabilityName_5_2 = (State_ServiceName_5_CapabilityName_5_2) ctx
				.lookup("java:global/large2/State_ServiceName_5_CapabilityName_5_2");
		...
		instanceState_ServiceName_5_CapabilityName_5_3 = (State_ServiceName_5_CapabilityName_5_3) ctx
				.lookup("java:global/large2/State_ServiceName_5_CapabilityName_5_3");
		...
		instanceState_ServiceName_5_CapabilityName_5_4 = (State_ServiceName_5_CapabilityName_5_4) ctx
				.lookup("java:global/large2/State_ServiceName_5_CapabilityName_5_4");
