...
import d.state.State_ServiceName_1_CapabilityName_1_1;
import d.state.State_ServiceName_1_CapabilityName_1_2;

import d.util.ConsumerHeader;
...
public class ServiceName_1Bean implements ServiceName_1 {
	...
	public OutputDataClassName_1_1 CapabilityName_1_1(
		...
		out.setOutputName_1_1_3(Integer.valueOf("164"));
	...
	public OutputDataClassName_1_2 CapabilityName_1_2(
		...
		out.setOutputName_1_2_1(Float.valueOf("595"));

		out.setOutputName_1_2_2("CapabilityName_1_2");

		out.setOutputName_1_2_3(Integer.valueOf("755"));

		out.setOutputName_1_2_4(Integer.valueOf("615"));
