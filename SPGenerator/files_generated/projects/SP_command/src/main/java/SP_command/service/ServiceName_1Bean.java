...
public class ServiceName_1Bean implements ServiceName_1 {
	...
	public OutputDataClassName_1_1 CapabilityName_1_1(
		...
		out.setOutputName_1_1_8(Float.valueOf("908"));

		out.setOutputName_1_1_6(Integer.valueOf("933"));

		out.setOutputName_1_1_7("CapabilityName_1_1");

		out.setOutputName_1_1_4(Float.valueOf("760"));

		out.setOutputName_1_1_5(Integer.valueOf("205"));

		out.setOutputName_1_1_2("CapabilityName_1_1");

		out.setOutputName_1_1_3(Integer.valueOf("19"));

		out.setOutputName_1_1_1(Integer.valueOf("281"));
	...
	public OutputDataClassName_1_2 CapabilityName_1_2(
		...
		out.setOutputName_1_2_2(Integer.valueOf("588"));
	...
	public OutputDataClassName_1_3 CapabilityName_1_3() {
		...
		out.setOutputName_1_3_4(Integer.valueOf("856"));

		out.setOutputName_1_3_2(Integer.valueOf("167"));

		out.setOutputName_1_3_3(Float.valueOf("653"));
	...
	public OutputDataClassName_1_4 CapabilityName_1_4() {
		...
		out.setOutputName_1_4_5(Float.valueOf("977"));

		out.setOutputName_1_4_3("CapabilityName_1_4");

		out.setOutputName_1_4_4("CapabilityName_1_4");

		out.setOutputName_1_4_1(Float.valueOf("947"));

		out.setOutputName_1_4_2(Integer.valueOf("506"));
