...
public class Composers_rest_ServiceName_3 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_3_3")) {
			...
			in.setInputName_3_3_5((Integer) source.getParameters()[2]);
			in.setInputName_3_3_3((String) source.getParameters()[3]);
			in.setInputName_3_3_4((String) source.getParameters()[4]);
		...
		if (opName.equals("CapabilityName_3_4")) {
			...
			in.setInputName_3_4_6((Integer) source.getParameters()[1]);
			in.setInputName_3_4_7((String) source.getParameters()[2]);
			in.setInputName_3_4_4((String) source.getParameters()[3]);
			in.setInputName_3_4_5((Float) source.getParameters()[4]);
			in.setInputName_3_4_2((Float) source.getParameters()[5]);
			in.setInputName_3_4_3((Float) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_5")) {
			...
			in.setInputName_3_5_8((Integer) source.getParameters()[1]);
			in.setInputName_3_5_5((Integer) source.getParameters()[2]);
			in.setInputName_3_5_6((String) source.getParameters()[3]);
			in.setInputName_3_5_3((Float) source.getParameters()[4]);
			in.setInputName_3_5_4((String) source.getParameters()[5]);
			in.setInputName_3_5_1((String) source.getParameters()[6]);
		...
		if (opName.equals("CapabilityName_3_6")) {
			...
			in.setInputName_3_6_1((Float) source.getParameters()[0]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_3_CapabilityName_3_3 = (State_ServiceName_3_CapabilityName_3_3) ctx
				.lookup("java:global/SP_command/State_ServiceName_3_CapabilityName_3_3");
		...
		instanceState_ServiceName_3_CapabilityName_3_5 = (State_ServiceName_3_CapabilityName_3_5) ctx
				.lookup("java:global/SP_command/State_ServiceName_3_CapabilityName_3_5");
		...
		instanceState_ServiceName_3_CapabilityName_3_1 = (State_ServiceName_3_CapabilityName_3_1) ctx
				.lookup("java:global/SP_command/State_ServiceName_3_CapabilityName_3_1");
