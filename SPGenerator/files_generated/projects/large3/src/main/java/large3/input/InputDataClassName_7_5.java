...
@XmlType(name = "inputDataClassName_7_5", propOrder = { "InputName_7_5_3",
		...
		"InputName_7_5_7", "InputName_7_5_5", "InputName_7_5_6" })
public class InputDataClassName_7_5 implements Serializable {
	...
	protected Float InputName_7_5_4;
	@XmlElement(name = "InputName_7_5_1")
	protected String InputName_7_5_1;
	@XmlElement(name = "InputName_7_5_2")
	protected Float InputName_7_5_2;
	@XmlElement(name = "InputName_7_5_7")
	protected String InputName_7_5_7;
	@XmlElement(name = "InputName_7_5_5")
	protected Float InputName_7_5_5;
	@XmlElement(name = "InputName_7_5_6")
	protected Float InputName_7_5_6;

	public Float getInputName_7_5_3() {
		return InputName_7_5_3;
	}

	public Float getInputName_7_5_4() {
		return InputName_7_5_4;
	}

	public String getInputName_7_5_1() {
	...
	public String getInputName_7_5_7() {
		return InputName_7_5_7;
	}

	public Float getInputName_7_5_5() {
		return InputName_7_5_5;
	}

	public Float getInputName_7_5_6() {
		return InputName_7_5_6;
	}
	...
	public void setInputName_7_5_4(Float value) {
		this.InputName_7_5_4 = value;
	}

	public void setInputName_7_5_1(String value) {
	...
	public void setInputName_7_5_7(String value) {
		this.InputName_7_5_7 = value;
	}

	public void setInputName_7_5_5(Float value) {
		this.InputName_7_5_5 = value;
	}

	public void setInputName_7_5_6(Float value) {
		this.InputName_7_5_6 = value;
	}
