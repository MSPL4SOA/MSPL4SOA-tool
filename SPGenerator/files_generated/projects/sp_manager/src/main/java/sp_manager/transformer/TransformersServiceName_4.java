...
public final class TransformersServiceName_4 {
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_4_1Response")
	public Element transformOutputDataClassName_4_1ToCapabilityName_4_1Response(
			OutputDataClassName_4_1 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_4_1:CapabilityName_4_1Response xmlns:OutputDataClassName_4_1=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_4_2Response")
	public Element transformOutputDataClassName_4_2ToCapabilityName_4_2Response(
			OutputDataClassName_4_2 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_4_2:CapabilityName_4_2Response xmlns:OutputDataClassName_4_2=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_4_3")
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_4_4Response")
	public Element transformOutputDataClassName_4_4ToCapabilityName_4_4Response(
			OutputDataClassName_4_4 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_4_4:CapabilityName_4_4Response xmlns:OutputDataClassName_4_4=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_4_4")
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_4_5Response")
	public Element transformOutputDataClassName_4_5ToCapabilityName_4_5Response(
			OutputDataClassName_4_5 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_4_5:CapabilityName_4_5Response xmlns:OutputDataClassName_4_5=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_4_5")
