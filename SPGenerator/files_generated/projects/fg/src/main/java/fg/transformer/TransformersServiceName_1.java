package fg.transformer;

import org.switchyard.annotations.Transformer;
import org.w3c.dom.Element;

import fg.util.XMLSOAPTransformers;
...
public final class TransformersServiceName_1 {
	...
	@Transformer(to = "{urn:fg:fg:1.0}CapabilityName_1_1Response")
	public Element transformOutputDataClassName_1_1ToCapabilityName_1_1Response(
			OutputDataClassName_1_1 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_1:CapabilityName_1_1Response xmlns:OutputDataClassName_1_1=\"urn:fg:fg:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:fg:fg:1.0}CapabilityName_1_1")
