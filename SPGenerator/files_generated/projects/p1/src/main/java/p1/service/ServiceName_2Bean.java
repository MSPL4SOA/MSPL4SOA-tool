...
import p1.state.State_ServiceName_2_CapabilityName_2_1;
import p1.state.State_ServiceName_2_CapabilityName_2_2;

import p1.util.ConsumerHeader;
...
public class ServiceName_2Bean implements ServiceName_2 {
	...
	public OutputDataClassName_2_1 CapabilityName_2_1() {
		...
		out.setOutputName_2_1_1(Integer.valueOf("881"));
