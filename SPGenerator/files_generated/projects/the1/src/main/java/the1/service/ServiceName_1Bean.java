...
import the1.state.State_ServiceName_1_CapabilityName_1_1;
import the1.state.State_ServiceName_1_CapabilityName_1_2;

import the1.util.ConsumerHeader;
...
public class ServiceName_1Bean implements ServiceName_1 {
	...
	public OutputDataClassName_1_1 CapabilityName_1_1(
		...
		out.setOutputName_1_1_2(Float.valueOf("571"));

		out.setOutputName_1_1_3(Integer.valueOf("412"));

		out.setOutputName_1_1_1(Float.valueOf("383"));
