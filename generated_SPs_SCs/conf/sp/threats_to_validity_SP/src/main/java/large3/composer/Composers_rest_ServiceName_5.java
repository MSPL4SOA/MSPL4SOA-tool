...
public class Composers_rest_ServiceName_5 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_5_6")) {
			...
			in.setInputName_5_6_1((Integer) source.getParameters()[0]);
			in.setInputName_5_6_4((Float) source.getParameters()[1]);
			in.setInputName_5_6_5((Float) source.getParameters()[2]);
			in.setInputName_5_6_2((Integer) source.getParameters()[3]);
			in.setInputName_5_6_3((String) source.getParameters()[4]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_1")) {
			...
			in.setInputName_5_1_5((String) source.getParameters()[2]);
			in.setInputName_5_1_6((String) source.getParameters()[3]);
			in.setInputName_5_1_3((Float) source.getParameters()[4]);
			in.setInputName_5_1_4((String) source.getParameters()[5]);
			in.setInputName_5_1_9((String) source.getParameters()[6]);
			in.setInputName_5_1_7((String) source.getParameters()[7]);
		...
		if (opName.equals("CapabilityName_5_2")) {
			...
			in.setInputName_5_2_4((Integer) source.getParameters()[1]);
		...
		if (opName.equals("CapabilityName_5_3")) {
			...
			in.setInputName_5_3_3((Integer) source.getParameters()[0]);
			in.setInputName_5_3_4((Float) source.getParameters()[1]);
			in.setInputName_5_3_1((Float) source.getParameters()[2]);
			in.setInputName_5_3_2((String) source.getParameters()[3]);
			in.setInputName_5_3_7((Integer) source.getParameters()[4]);
			in.setInputName_5_3_8((Float) source.getParameters()[5]);
			in.setInputName_5_3_5((Integer) source.getParameters()[6]);
			in.setInputName_5_3_6((Integer) source.getParameters()[7]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_4")) {
			...
			in.setInputName_5_4_8((String) source.getParameters()[0]);
			in.setInputName_5_4_9((Float) source.getParameters()[1]);
			in.setInputName_5_4_2((Float) source.getParameters()[2]);
			in.setInputName_5_4_3((Float) source.getParameters()[3]);
			in.setInputName_5_4_1((Float) source.getParameters()[4]);
			in.setInputName_5_4_6((String) source.getParameters()[5]);
			in.setInputName_5_4_7((String) source.getParameters()[6]);
			in.setInputName_5_4_4((Float) source.getParameters()[7]);
			in.setInputName_5_4_5((String) source.getParameters()[8]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_5_CapabilityName_5_5 = (State_ServiceName_5_CapabilityName_5_5) ctx
				.lookup("java:global/large3/State_ServiceName_5_CapabilityName_5_5");
		...
		instanceState_ServiceName_5_CapabilityName_5_6 = (State_ServiceName_5_CapabilityName_5_6) ctx
				.lookup("java:global/large3/State_ServiceName_5_CapabilityName_5_6");
		...
		instanceState_ServiceName_5_CapabilityName_5_1 = (State_ServiceName_5_CapabilityName_5_1) ctx
				.lookup("java:global/large3/State_ServiceName_5_CapabilityName_5_1");
		...
		instanceState_ServiceName_5_CapabilityName_5_2 = (State_ServiceName_5_CapabilityName_5_2) ctx
				.lookup("java:global/large3/State_ServiceName_5_CapabilityName_5_2");
		...
		instanceState_ServiceName_5_CapabilityName_5_3 = (State_ServiceName_5_CapabilityName_5_3) ctx
				.lookup("java:global/large3/State_ServiceName_5_CapabilityName_5_3");
		...
		instanceState_ServiceName_5_CapabilityName_5_4 = (State_ServiceName_5_CapabilityName_5_4) ctx
				.lookup("java:global/large3/State_ServiceName_5_CapabilityName_5_4");
