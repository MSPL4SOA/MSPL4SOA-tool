 ...
 * 2016-09-15T23:31:49.218+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_3", wsdlLocation = "http://localhost:8080/large3/ServiceName_3/ServiceName_3?wsdl", targetNamespace = "urn:large3:large3:1.0")
public class ServiceName3 extends Service {
	...
	public final static QName ServiceName3Port = new QName(
			"urn:large3:large3:1.0", "ServiceName_3Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/large3/ServiceName_3/ServiceName_3?wsdl");
