 ...
 * 2016-09-15T23:31:47.777+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_6", wsdlLocation = "http://localhost:8080/large3/ServiceName_6/ServiceName_6?wsdl", targetNamespace = "urn:large3:large3:1.0")
public class ServiceName6 extends Service {
	...
	public final static QName ServiceName6Port = new QName(
			"urn:large3:large3:1.0", "ServiceName_6Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/large3/ServiceName_6/ServiceName_6?wsdl");
