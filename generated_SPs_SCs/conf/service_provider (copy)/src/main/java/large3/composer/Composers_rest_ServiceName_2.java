...
public class Composers_rest_ServiceName_2 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_2_4")) {
			...
			in.setInputName_2_4_5((String) source.getParameters()[4]);
		...
		if (opName.equals("CapabilityName_2_1")) {
			...
			in.setInputName_2_1_10((Float) source.getParameters()[0]);
			in.setInputName_2_1_1((Integer) source.getParameters()[1]);
			in.setInputName_2_1_2((String) source.getParameters()[2]);
			in.setInputName_2_1_3((Integer) source.getParameters()[3]);
			in.setInputName_2_1_4((Float) source.getParameters()[4]);
			in.setInputName_2_1_5((Float) source.getParameters()[5]);
			in.setInputName_2_1_6((String) source.getParameters()[6]);
			in.setInputName_2_1_7((String) source.getParameters()[7]);
			in.setInputName_2_1_8((String) source.getParameters()[8]);
			in.setInputName_2_1_9((Integer) source.getParameters()[9]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_2_2")) {
			...
			in.setInputName_2_2_7((Integer) source.getParameters()[6]);
		...
		if (opName.equals("CapabilityName_2_3")) {
			...
			in.setInputName_2_3_5((String) source.getParameters()[4]);
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_2_CapabilityName_2_4 = (State_ServiceName_2_CapabilityName_2_4) ctx
				.lookup("java:global/large3/State_ServiceName_2_CapabilityName_2_4");
		...
		instanceState_ServiceName_2_CapabilityName_2_5 = (State_ServiceName_2_CapabilityName_2_5) ctx
				.lookup("java:global/large3/State_ServiceName_2_CapabilityName_2_5");
		...
		instanceState_ServiceName_2_CapabilityName_2_1 = (State_ServiceName_2_CapabilityName_2_1) ctx
				.lookup("java:global/large3/State_ServiceName_2_CapabilityName_2_1");
		...
		instanceState_ServiceName_2_CapabilityName_2_2 = (State_ServiceName_2_CapabilityName_2_2) ctx
				.lookup("java:global/large3/State_ServiceName_2_CapabilityName_2_2");
		...
		instanceState_ServiceName_2_CapabilityName_2_3 = (State_ServiceName_2_CapabilityName_2_3) ctx
				.lookup("java:global/large3/State_ServiceName_2_CapabilityName_2_3");
