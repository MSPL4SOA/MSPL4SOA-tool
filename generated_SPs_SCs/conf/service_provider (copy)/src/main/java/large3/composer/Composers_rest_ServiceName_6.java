...
public class Composers_rest_ServiceName_6 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_6_4")) {
			...
			in.setInputName_6_4_2((String) source.getParameters()[1]);
			in.setInputName_6_4_3((Integer) source.getParameters()[2]);
			in.setInputName_6_4_4((Integer) source.getParameters()[3]);
			in.setInputName_6_4_5((Float) source.getParameters()[4]);
			in.setInputName_6_4_6((Integer) source.getParameters()[5]);
		...
		if (opName.equals("CapabilityName_6_5")) {
			...
			in.setInputName_6_5_3((String) source.getParameters()[2]);
			in.setInputName_6_5_4((String) source.getParameters()[3]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_6_6")) {
			...
			in.setInputName_6_6_3((Integer) source.getParameters()[2]);
		...
		if (opName.equals("CapabilityName_6_1")) {
			...
			in.setInputName_6_1_4((String) source.getParameters()[2]);
			...
			in.setInputName_6_1_1((Float) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_6_2")) {
			...
			in.setInputName_6_2_3((Integer) source.getParameters()[2]);
			in.setInputName_6_2_4((String) source.getParameters()[3]);
			in.setInputName_6_2_5((String) source.getParameters()[4]);
			in.setInputName_6_2_6((String) source.getParameters()[5]);
			in.setInputName_6_2_7((Integer) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_6_3")) {
			...
			in.setInputName_6_3_3((Float) source.getParameters()[2]);
			in.setInputName_6_3_4((Float) source.getParameters()[3]);
			in.setInputName_6_3_5((Integer) source.getParameters()[4]);
			in.setInputName_6_3_6((Float) source.getParameters()[5]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_6_CapabilityName_6_4 = (State_ServiceName_6_CapabilityName_6_4) ctx
				.lookup("java:global/large3/State_ServiceName_6_CapabilityName_6_4");
		...
		instanceState_ServiceName_6_CapabilityName_6_5 = (State_ServiceName_6_CapabilityName_6_5) ctx
				.lookup("java:global/large3/State_ServiceName_6_CapabilityName_6_5");
		...
		instanceState_ServiceName_6_CapabilityName_6_6 = (State_ServiceName_6_CapabilityName_6_6) ctx
				.lookup("java:global/large3/State_ServiceName_6_CapabilityName_6_6");
		...
		instanceState_ServiceName_6_CapabilityName_6_1 = (State_ServiceName_6_CapabilityName_6_1) ctx
				.lookup("java:global/large3/State_ServiceName_6_CapabilityName_6_1");
		...
		instanceState_ServiceName_6_CapabilityName_6_2 = (State_ServiceName_6_CapabilityName_6_2) ctx
				.lookup("java:global/large3/State_ServiceName_6_CapabilityName_6_2");
		...
		instanceState_ServiceName_6_CapabilityName_6_3 = (State_ServiceName_6_CapabilityName_6_3) ctx
				.lookup("java:global/large3/State_ServiceName_6_CapabilityName_6_3");
