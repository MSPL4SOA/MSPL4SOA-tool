...
@XmlType(name = "outputDataClassName_5_2", propOrder = { "OutputName_5_2_1",
		"OutputName_5_2_2", "OutputName_5_2_7", "OutputName_5_2_5",
		"OutputName_5_2_6", "OutputName_5_2_3", "OutputName_5_2_4" })
public class OutputDataClassName_5_2 implements Serializable {
	...
	public Integer getOutputName_5_2_6() {
		return OutputName_5_2_6;
	}

	public String getOutputName_5_2_3() {
		return OutputName_5_2_3;
	}

	public String getOutputName_5_2_4() {
	...
	public void setOutputName_5_2_2(Float value) {
		this.OutputName_5_2_2 = value;
	}

	public void setOutputName_5_2_7(String value) {
	...
	public void setOutputName_5_2_6(Integer value) {
		this.OutputName_5_2_6 = value;
	}

	public void setOutputName_5_2_3(String value) {
		this.OutputName_5_2_3 = value;
	}

	public void setOutputName_5_2_4(String value) {
