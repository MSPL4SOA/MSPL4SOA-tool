...
public class Composers_rest_ServiceName_7 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_7_3")) {
			...
			in.setInputName_7_3_3((Integer) source.getParameters()[0]);
			in.setInputName_7_3_4((String) source.getParameters()[1]);
			in.setInputName_7_3_1((Integer) source.getParameters()[2]);
			in.setInputName_7_3_2((String) source.getParameters()[3]);
		...
		if (opName.equals("CapabilityName_7_4")) {
			...
			in.setInputName_7_4_4((Integer) source.getParameters()[0]);
			in.setInputName_7_4_5((Integer) source.getParameters()[1]);
			in.setInputName_7_4_2((Float) source.getParameters()[2]);
			in.setInputName_7_4_3((Integer) source.getParameters()[3]);
			in.setInputName_7_4_1((String) source.getParameters()[4]);
			in.setInputName_7_4_6((Integer) source.getParameters()[5]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_7_5")) {
			...
			in.setInputName_7_5_4((Float) source.getParameters()[1]);
			in.setInputName_7_5_1((String) source.getParameters()[2]);
			in.setInputName_7_5_2((Float) source.getParameters()[3]);
			in.setInputName_7_5_7((String) source.getParameters()[4]);
			in.setInputName_7_5_5((Float) source.getParameters()[5]);
			in.setInputName_7_5_6((Float) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_7_1")) {
			...
			in.setInputName_7_1_7((Float) source.getParameters()[0]);
			in.setInputName_7_1_8((Float) source.getParameters()[1]);
			in.setInputName_7_1_5((Integer) source.getParameters()[2]);
			in.setInputName_7_1_6((Float) source.getParameters()[3]);
			in.setInputName_7_1_3((Integer) source.getParameters()[4]);
			in.setInputName_7_1_4((String) source.getParameters()[5]);
			in.setInputName_7_1_1((String) source.getParameters()[6]);
			in.setInputName_7_1_2((Integer) source.getParameters()[7]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_7_2")) {
			...
			in.setInputName_7_2_7((Integer) source.getParameters()[1]);
			in.setInputName_7_2_4((Integer) source.getParameters()[2]);
			in.setInputName_7_2_5((String) source.getParameters()[3]);
			in.setInputName_7_2_2((Float) source.getParameters()[4]);
			in.setInputName_7_2_3((Float) source.getParameters()[5]);
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_7_CapabilityName_7_3 = (State_ServiceName_7_CapabilityName_7_3) ctx
				.lookup("java:global/large3/State_ServiceName_7_CapabilityName_7_3");
		...
		instanceState_ServiceName_7_CapabilityName_7_4 = (State_ServiceName_7_CapabilityName_7_4) ctx
				.lookup("java:global/large3/State_ServiceName_7_CapabilityName_7_4");
		...
		instanceState_ServiceName_7_CapabilityName_7_1 = (State_ServiceName_7_CapabilityName_7_1) ctx
				.lookup("java:global/large3/State_ServiceName_7_CapabilityName_7_1");
		...
		instanceState_ServiceName_7_CapabilityName_7_2 = (State_ServiceName_7_CapabilityName_7_2) ctx
				.lookup("java:global/large3/State_ServiceName_7_CapabilityName_7_2");
