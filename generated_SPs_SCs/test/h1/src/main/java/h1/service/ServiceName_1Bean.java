...
import h1.state.State_ServiceName_1_CapabilityName_1_1;
import h1.state.State_ServiceName_1_CapabilityName_1_2;
...
public class ServiceName_1Bean implements ServiceName_1 {
	...
	public OutputDataClassName_1_1 CapabilityName_1_1(
		...
		out.setOutputName_1_1_3(Float.valueOf("234"));

		out.setOutputName_1_1_1(Integer.valueOf("776"));
