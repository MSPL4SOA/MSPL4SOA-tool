...
import sp_manager.output.OutputDataClassName_1_1;
import sp_manager.output.OutputDataClassName_1_2;
import sp_manager.output.OutputDataClassName_1_3;
import sp_manager.output.OutputDataClassName_1_4;
import sp_manager.output.OutputDataClassName_1_5;

public final class TransformersServiceName_1 {

	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_1Response")
	public Element transformOutputDataClassName_1_1ToCapabilityName_1_1Response(
			OutputDataClassName_1_1 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_1:CapabilityName_1_1Response xmlns:OutputDataClassName_1_1=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_1")
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_2Response")
	public Element transformOutputDataClassName_1_2ToCapabilityName_1_2Response(
			OutputDataClassName_1_2 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_2:CapabilityName_1_2Response xmlns:OutputDataClassName_1_2=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_2")
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_3Response")
	public Element transformOutputDataClassName_1_3ToCapabilityName_1_3Response(
			OutputDataClassName_1_3 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_3:CapabilityName_1_3Response xmlns:OutputDataClassName_1_3=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_3")
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_4Response")
	public Element transformOutputDataClassName_1_4ToCapabilityName_1_4Response(
			OutputDataClassName_1_4 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_4:CapabilityName_1_4Response xmlns:OutputDataClassName_1_4=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_4")
	...
	@Transformer(to = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_5Response")
	public Element transformOutputDataClassName_1_5ToCapabilityName_1_5Response(
			OutputDataClassName_1_5 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_1_5:CapabilityName_1_5Response xmlns:OutputDataClassName_1_5=\"urn:sp_manager:sp_manager:1.0\">")
				.append("<return>")
	...
	@Transformer(from = "{urn:sp_manager:sp_manager:1.0}CapabilityName_1_5")
