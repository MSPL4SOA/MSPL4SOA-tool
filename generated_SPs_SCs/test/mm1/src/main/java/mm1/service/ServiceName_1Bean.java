...
import mm1.state.State_ServiceName_1_CapabilityName_1_1;

import mm1.util.ConsumerHeader;
...
public class ServiceName_1Bean implements ServiceName_1 {
	...
	public OutputDataClassName_1_1 CapabilityName_1_1(
		...
		out.setOutputName_1_1_2(Integer.valueOf("396"));

		out.setOutputName_1_1_1(Integer.valueOf("174"));
