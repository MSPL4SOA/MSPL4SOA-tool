...
public class Composers_rest_ServiceName_7 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_7_3")) {
			...
			in.setInputName_7_3_5((Integer) source.getParameters()[0]);
			in.setInputName_7_3_6((Float) source.getParameters()[1]);
			in.setInputName_7_3_3((Integer) source.getParameters()[2]);
			in.setInputName_7_3_4((String) source.getParameters()[3]);
			in.setInputName_7_3_1((Float) source.getParameters()[4]);
			in.setInputName_7_3_2((String) source.getParameters()[5]);
			in.setInputName_7_3_9((String) source.getParameters()[6]);
			in.setInputName_7_3_7((Integer) source.getParameters()[7]);
			in.setInputName_7_3_8((Integer) source.getParameters()[8]);
		...
		if (opName.equals("CapabilityName_7_4")) {
			...
			in.setInputName_7_4_4((String) source.getParameters()[0]);
			in.setInputName_7_4_5((String) source.getParameters()[1]);
			...
			in.setInputName_7_4_6((String) source.getParameters()[5]);
			in.setInputName_7_4_7((Float) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_7_1")) {
			...
			in.setInputName_7_1_5((String) source.getParameters()[1]);
			in.setInputName_7_1_6((Float) source.getParameters()[2]);
			in.setInputName_7_1_3((String) source.getParameters()[3]);
			in.setInputName_7_1_4((Integer) source.getParameters()[4]);
			in.setInputName_7_1_1((Float) source.getParameters()[5]);
			in.setInputName_7_1_2((Float) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_7_2")) {
			...
			in.setInputName_7_2_6((String) source.getParameters()[0]);
			in.setInputName_7_2_7((Float) source.getParameters()[1]);
			in.setInputName_7_2_4((Float) source.getParameters()[2]);
			in.setInputName_7_2_5((Integer) source.getParameters()[3]);
			in.setInputName_7_2_2((String) source.getParameters()[4]);
			in.setInputName_7_2_3((Float) source.getParameters()[5]);
			in.setInputName_7_2_1((String) source.getParameters()[6]);
