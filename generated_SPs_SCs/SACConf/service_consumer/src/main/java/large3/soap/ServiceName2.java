 ...
 * 2016-09-15T23:31:49.493+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_2", wsdlLocation = "http://localhost:8080/large3/ServiceName_2/ServiceName_2?wsdl", targetNamespace = "urn:large3:large3:1.0")
public class ServiceName2 extends Service {
	...
	public final static QName ServiceName2Port = new QName(
			"urn:large3:large3:1.0", "ServiceName_2Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/large3/ServiceName_2/ServiceName_2?wsdl");
