 ...
 * 2016-09-15T23:31:48.756+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_5", wsdlLocation = "http://localhost:8080/large3/ServiceName_5/ServiceName_5?wsdl", targetNamespace = "urn:large3:large3:1.0")
public class ServiceName5 extends Service {
	...
	public final static QName ServiceName5Port = new QName(
			"urn:large3:large3:1.0", "ServiceName_5Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/large3/ServiceName_5/ServiceName_5?wsdl");
