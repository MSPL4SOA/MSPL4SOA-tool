...
public class Composers_rest_ServiceName_3 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_3_3")) {
			...
			in.setInputName_3_3_3((Integer) source.getParameters()[3]);
		...
		if (opName.equals("CapabilityName_3_4")) {
			...
			in.setInputName_3_4_2((String) source.getParameters()[1]);
			in.setInputName_3_4_3((Float) source.getParameters()[2]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_5")) {
			...
			in.setInputName_3_5_5((Float) source.getParameters()[0]);
			in.setInputName_3_5_6((Float) source.getParameters()[1]);
			in.setInputName_3_5_3((Float) source.getParameters()[2]);
			in.setInputName_3_5_4((Float) source.getParameters()[3]);
			in.setInputName_3_5_1((Float) source.getParameters()[4]);
		...
		if (opName.equals("CapabilityName_3_2")) {
			...
			in.setInputName_3_2_8((Integer) source.getParameters()[3]);
			in.setInputName_3_2_9((String) source.getParameters()[4]);
			in.setInputName_3_2_6((Integer) source.getParameters()[5]);
			in.setInputName_3_2_7((String) source.getParameters()[6]);
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_3_CapabilityName_3_5 = (State_ServiceName_3_CapabilityName_3_5) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_3_CapabilityName_3_5");
		...
		instanceState_ServiceName_3_CapabilityName_3_1 = (State_ServiceName_3_CapabilityName_3_1) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_3_CapabilityName_3_1");
		...
		instanceState_ServiceName_3_CapabilityName_3_2 = (State_ServiceName_3_CapabilityName_3_2) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_3_CapabilityName_3_2");
