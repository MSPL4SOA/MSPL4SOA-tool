...
public class Composers_rest_ServiceName_4 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_4_2")) {
			...
			in.setInputName_4_2_2((Float) source.getParameters()[1]);
		...
		if (opName.equals("CapabilityName_4_3")) {
			...
			in.setInputName_4_3_6((Float) source.getParameters()[0]);
			in.setInputName_4_3_7((String) source.getParameters()[1]);
			in.setInputName_4_3_8((Float) source.getParameters()[2]);
			in.setInputName_4_3_9((Float) source.getParameters()[3]);
			in.setInputName_4_3_2((Float) source.getParameters()[4]);
			in.setInputName_4_3_3((String) source.getParameters()[5]);
			in.setInputName_4_3_4((Integer) source.getParameters()[6]);
			in.setInputName_4_3_5((Float) source.getParameters()[7]);
			in.setInputName_4_3_1((Integer) source.getParameters()[8]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_4")) {
			...
			in.setInputName_4_4_1((Integer) source.getParameters()[0]);
			in.setInputName_4_4_2((Integer) source.getParameters()[1]);
			in.setInputName_4_4_3((Float) source.getParameters()[2]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_5")) {
			...
			in.setInputName_4_5_5((Float) source.getParameters()[1]);
			in.setInputName_4_5_1((Float) source.getParameters()[2]);
			in.setInputName_4_5_2((String) source.getParameters()[3]);
			in.setInputName_4_5_3((Float) source.getParameters()[4]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_1")) {
			...
			in.setInputName_4_1_8((Integer) source.getParameters()[0]);
			in.setInputName_4_1_4((Float) source.getParameters()[1]);
			...
			in.setInputName_4_1_1((String) source.getParameters()[5]);
			in.setInputName_4_1_2((Float) source.getParameters()[6]);
			in.setInputName_4_1_3((String) source.getParameters()[7]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_4_CapabilityName_4_2 = (State_ServiceName_4_CapabilityName_4_2) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_4_CapabilityName_4_2");
		...
		instanceState_ServiceName_4_CapabilityName_4_3 = (State_ServiceName_4_CapabilityName_4_3) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_4_CapabilityName_4_3");
		...
		instanceState_ServiceName_4_CapabilityName_4_4 = (State_ServiceName_4_CapabilityName_4_4) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_4_CapabilityName_4_4");
		...
		instanceState_ServiceName_4_CapabilityName_4_1 = (State_ServiceName_4_CapabilityName_4_1) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_4_CapabilityName_4_1");
