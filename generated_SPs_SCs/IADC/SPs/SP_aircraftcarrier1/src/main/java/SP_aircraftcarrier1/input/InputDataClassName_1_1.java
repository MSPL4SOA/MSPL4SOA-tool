...
@XmlType(name = "inputDataClassName_1_1", propOrder = { "InputName_1_1_1",
		"InputName_1_1_2", "InputName_1_1_5", "InputName_1_1_6",
		"InputName_1_1_3", "InputName_1_1_4" })
public class InputDataClassName_1_1 implements Serializable {
	...
	@XmlElement(name = "InputName_1_1_6")
	protected String InputName_1_1_6;
	...
	public String getInputName_1_1_6() {
		return InputName_1_1_6;
	}
	...
	public void setInputName_1_1_6(String value) {
		this.InputName_1_1_6 = value;
	}
