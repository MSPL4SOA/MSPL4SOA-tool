...
public final class TransformersServiceName_4 {
	...
	public InputDataClassName_4_3 transformCapabilityName_4_3ToInputDataClassName_4_3(
		...
		in.setInputName_4_3_7(Float.valueOf(XMLSOAPTransformers
				.getElementValue(from, "InputName_4_3_7")));
		in.setInputName_4_3_8(String.valueOf(XMLSOAPTransformers
		...
		in.setInputName_4_3_5(Integer.valueOf(XMLSOAPTransformers
	...
	public Element transformOutputDataClassName_4_5ToCapabilityName_4_5Response(
		...
		StringBuffer resultXml = new StringBuffer()
				...
				.append("<OutputName_4_5_6>" + from.getOutputName_4_5_6()
						+ "</OutputName_4_5_6>")
				.append("<OutputName_4_5_7>" + from.getOutputName_4_5_7()
						+ "</OutputName_4_5_7>")
				.append("</return>")
	...
	public InputDataClassName_4_5 transformCapabilityName_4_5ToInputDataClassName_4_5(
		...
		in.setInputName_4_5_8(String.valueOf(XMLSOAPTransformers
				.getElementValue(from, "InputName_4_5_8")));
		in.setInputName_4_5_9(String.valueOf(XMLSOAPTransformers
				.getElementValue(from, "InputName_4_5_9")));
		in.setInputName_4_5_4(String.valueOf(XMLSOAPTransformers
		...
		in.setInputName_4_5_6(String.valueOf(XMLSOAPTransformers
		...
		in.setInputName_4_5_2(Integer.valueOf(XMLSOAPTransformers
