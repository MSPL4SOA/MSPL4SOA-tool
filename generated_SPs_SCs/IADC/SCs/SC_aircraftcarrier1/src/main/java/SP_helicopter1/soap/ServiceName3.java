 ...
 * 2017-06-11T03:42:35.020+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_3", wsdlLocation = "http://localhost:8080/SP_helicopter1/ServiceName_3/ServiceName_3?wsdl", targetNamespace = "urn:SP_helicopter1:SP_helicopter1:1.0")
public class ServiceName3 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:SP_helicopter1:SP_helicopter1:1.0", "ServiceName_3");
	public final static QName ServiceName3Port = new QName(
			"urn:SP_helicopter1:SP_helicopter1:1.0", "ServiceName_3Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/SP_helicopter1/ServiceName_3/ServiceName_3?wsdl");
