...
public interface ServiceName4PortType {
	...
	@ResponseWrapper(localName = "CapabilityName_4_5Response", targetNamespace = "urn:SP_command:SP_command:1.0", className = "SP_command.soap.CapabilityName_4_5Response")
	public Response<SP_command.soap.CapabilityName_4_5Response> capabilityName45Async(
	...
	public Future<?> capabilityName45Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_command:SP_command:1.0") InputDataClassName_4_5 arg0,
			@WebParam(name = "asyncHandler", targetNamespace = "") AsyncHandler<SP_command.soap.CapabilityName_4_5Response> asyncHandler);
	...
	public Response<SP_command.soap.CapabilityName_4_4Response> capabilityName44Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_command:SP_command:1.0") InputDataClassName_4_4 arg0);
	...
	@ResponseWrapper(localName = "CapabilityName_4_1Response", targetNamespace = "urn:SP_command:SP_command:1.0", className = "SP_command.soap.CapabilityName_4_1Response")
	public Response<SP_command.soap.CapabilityName_4_1Response> capabilityName41Async(
	...
	public Future<?> capabilityName41Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_command:SP_command:1.0") InputDataClassName_4_1 arg0,
			@WebParam(name = "asyncHandler", targetNamespace = "") AsyncHandler<SP_command.soap.CapabilityName_4_1Response> asyncHandler);
