...
public interface ServiceName5PortType {
	...
	public void capabilityName54(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_command:SP_command:1.0") InputDataClassName_5_4 arg0);
	...
	@ResponseWrapper(localName = "CapabilityName_5_2Response", targetNamespace = "urn:SP_command:SP_command:1.0", className = "SP_command.soap.CapabilityName_5_2Response")
	public Response<SP_command.soap.CapabilityName_5_2Response> capabilityName52Async(
	...
	public Future<?> capabilityName52Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_command:SP_command:1.0") InputDataClassName_5_2 arg0,
			@WebParam(name = "asyncHandler", targetNamespace = "") AsyncHandler<SP_command.soap.CapabilityName_5_2Response> asyncHandler);
