...
public interface ServiceName3PortType {
	...
	@ResponseWrapper(localName = "CapabilityName_3_5Response", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0", className = "SP_aircraftcarrier1.soap.CapabilityName_3_5Response")
	public Response<SP_aircraftcarrier1.soap.CapabilityName_3_5Response> capabilityName35Async(
	...
	public Future<?> capabilityName35Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0") InputDataClassName_3_5 arg0,
			@WebParam(name = "asyncHandler", targetNamespace = "") AsyncHandler<SP_aircraftcarrier1.soap.CapabilityName_3_5Response> asyncHandler);
	...
	@ResponseWrapper(localName = "CapabilityName_3_2Response", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0", className = "SP_aircraftcarrier1.soap.CapabilityName_3_2Response")
	public Response<SP_aircraftcarrier1.soap.CapabilityName_3_2Response> capabilityName32Async(
	...
	public Future<?> capabilityName32Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0") InputDataClassName_3_2 arg0,
			@WebParam(name = "asyncHandler", targetNamespace = "") AsyncHandler<SP_aircraftcarrier1.soap.CapabilityName_3_2Response> asyncHandler);
	...
	@ResponseWrapper(localName = "CapabilityName_3_1Response", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0", className = "SP_aircraftcarrier1.soap.CapabilityName_3_1Response")
	public Response<SP_aircraftcarrier1.soap.CapabilityName_3_1Response> capabilityName31Async(
	...
	public Future<?> capabilityName31Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0") InputDataClassName_3_1 arg0,
			@WebParam(name = "asyncHandler", targetNamespace = "") AsyncHandler<SP_aircraftcarrier1.soap.CapabilityName_3_1Response> asyncHandler);
