 ...
 * 2017-06-11T03:38:51.255+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_5", wsdlLocation = "http://localhost:8080/SP_aircraftcarrier1/ServiceName_5/ServiceName_5?wsdl", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0")
public class ServiceName5 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0", "ServiceName_5");
	...
	static {
		...
		try {
			url = new URL(
					"http://localhost:8080/SP_aircraftcarrier1/ServiceName_5/ServiceName_5?wsdl");
