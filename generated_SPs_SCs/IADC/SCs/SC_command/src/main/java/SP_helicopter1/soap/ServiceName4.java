 ...
 * 2017-06-11T03:12:04.777+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_4", wsdlLocation = "http://localhost:8080/SP_helicopter1/ServiceName_4/ServiceName_4?wsdl", targetNamespace = "urn:SP_helicopter1:SP_helicopter1:1.0")
public class ServiceName4 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:SP_helicopter1:SP_helicopter1:1.0", "ServiceName_4");
	public final static QName ServiceName4Port = new QName(
			"urn:SP_helicopter1:SP_helicopter1:1.0", "ServiceName_4Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/SP_helicopter1/ServiceName_4/ServiceName_4?wsdl");
