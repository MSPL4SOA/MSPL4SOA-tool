 ...
 * 2017-06-11T03:12:04.556+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_5", wsdlLocation = "http://localhost:8080/SP_helicopter1/ServiceName_5/ServiceName_5?wsdl", targetNamespace = "urn:SP_helicopter1:SP_helicopter1:1.0")
public class ServiceName5 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:SP_helicopter1:SP_helicopter1:1.0", "ServiceName_5");
	public final static QName ServiceName5Port = new QName(
			"urn:SP_helicopter1:SP_helicopter1:1.0", "ServiceName_5Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/SP_helicopter1/ServiceName_5/ServiceName_5?wsdl");
