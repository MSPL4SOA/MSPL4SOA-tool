 ...
 * 2017-06-11T03:09:30.782+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_6", wsdlLocation = "http://localhost:8080/SP_infantry1/ServiceName_6/ServiceName_6?wsdl", targetNamespace = "urn:SP_infantry1:SP_infantry1:1.0")
public class ServiceName6 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:SP_infantry1:SP_infantry1:1.0", "ServiceName_6");
	public final static QName ServiceName6Port = new QName(
			"urn:SP_infantry1:SP_infantry1:1.0", "ServiceName_6Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/SP_infantry1/ServiceName_6/ServiceName_6?wsdl");
