...
public interface ServiceName3PortType {
	...
	@ResponseWrapper(localName = "CapabilityName_3_1Response", targetNamespace = "urn:SP_infantry1:SP_infantry1:1.0", className = "SP_infantry1.soap.CapabilityName_3_1Response")
	public Response<SP_infantry1.soap.CapabilityName_3_1Response> capabilityName31Async(
	...
	public Future<?> capabilityName31Async(
			@WebParam(name = "arg0", targetNamespace = "urn:SP_infantry1:SP_infantry1:1.0") InputDataClassName_3_1 arg0,
			@WebParam(name = "asyncHandler", targetNamespace = "") AsyncHandler<SP_infantry1.soap.CapabilityName_3_1Response> asyncHandler);
