...
@XmlType(name = "inputDataClassName_2_1", propOrder = { "InputName_2_1_1",
		...
		"InputName_2_1_5", "InputName_2_1_6", "InputName_2_1_7",
		"InputName_2_1_8", "InputName_2_1_9" })
public class InputDataClassName_2_1 implements Serializable {
	...
	protected Integer InputName_2_1_6;
	@XmlElement(name = "InputName_2_1_7")
	protected Integer InputName_2_1_7;
	@XmlElement(name = "InputName_2_1_8")
	protected Float InputName_2_1_8;
	@XmlElement(name = "InputName_2_1_9")
	protected String InputName_2_1_9;
	...
	public Integer getInputName_2_1_6() {
		return InputName_2_1_6;
	}

	public Integer getInputName_2_1_7() {
		return InputName_2_1_7;
	}

	public Float getInputName_2_1_8() {
		return InputName_2_1_8;
	}

	public String getInputName_2_1_9() {
	...
	public void setInputName_2_1_6(Integer value) {
		this.InputName_2_1_6 = value;
	}

	public void setInputName_2_1_7(Integer value) {
		this.InputName_2_1_7 = value;
	}

	public void setInputName_2_1_8(Float value) {
		this.InputName_2_1_8 = value;
	}

	public void setInputName_2_1_9(String value) {
