...
public interface Resource_restServiceName_4 {
	...
	@GET
	@Path("/CapabilityName_4_6/{InputName_4_6_7}/{InputName_4_6_3}/{InputName_4_6_4}/{InputName_4_6_5}/{InputName_4_6_6}/{InputName_4_6_1}/{InputName_4_6_2}/")
	@Produces({ "text/xml" })
	public Response CapabilityName_4_6(

	@PathParam("InputName_4_6_7") String InputName_4_6_7
	...
	, @PathParam("InputName_4_6_6") Float InputName_4_6_6

	, @PathParam("InputName_4_6_1") Integer InputName_4_6_1

	, @PathParam("InputName_4_6_2") String InputName_4_6_2

	);

	@GET
	@Path("/CapabilityName_4_2/{InputName_4_2_1}/")
	@Produces({ "text/xml" })
	...
	@POST
	@Path("/CapabilityName_4_5/{InputName_4_5_1}/{InputName_4_5_2}/")
	@Produces({ "text/xml" })
