...
@XmlType(name = "outputDataClassName_7_1", propOrder = { "OutputName_7_1_1",
		...
		"OutputName_7_1_2", "OutputName_7_1_9", "OutputName_7_1_8",
		"OutputName_7_1_7", "OutputName_7_1_6" })
public class OutputDataClassName_7_1 implements Serializable {

	private static final long serialVersionUID = 1L;

	@XmlElement(name = "OutputName_7_1_1")
	protected Integer OutputName_7_1_1;
	@XmlElement(name = "OutputName_7_1_5")
	protected String OutputName_7_1_5;
	@XmlElement(name = "OutputName_7_1_4")
	protected Float OutputName_7_1_4;
	@XmlElement(name = "OutputName_7_1_3")
	protected Integer OutputName_7_1_3;
	@XmlElement(name = "OutputName_7_1_2")
	protected Integer OutputName_7_1_2;
	@XmlElement(name = "OutputName_7_1_9")
	protected Float OutputName_7_1_9;
	@XmlElement(name = "OutputName_7_1_8")
	protected Float OutputName_7_1_8;
	@XmlElement(name = "OutputName_7_1_7")
	protected Integer OutputName_7_1_7;
	@XmlElement(name = "OutputName_7_1_6")
	protected Integer OutputName_7_1_6;

	public Integer getOutputName_7_1_1() {
		return OutputName_7_1_1;
	}

	public String getOutputName_7_1_5() {
	...
	public Integer getOutputName_7_1_3() {
		return OutputName_7_1_3;
	}

	public Integer getOutputName_7_1_2() {
		return OutputName_7_1_2;
	}

	public Float getOutputName_7_1_9() {
		return OutputName_7_1_9;
	}
	...
	public Integer getOutputName_7_1_7() {
		return OutputName_7_1_7;
	}

	public Integer getOutputName_7_1_6() {
		return OutputName_7_1_6;
	}

	public void setOutputName_7_1_1(Integer value) {
		this.OutputName_7_1_1 = value;
	}

	public void setOutputName_7_1_5(String value) {
	...
	public void setOutputName_7_1_3(Integer value) {
		this.OutputName_7_1_3 = value;
	}

	public void setOutputName_7_1_2(Integer value) {
		this.OutputName_7_1_2 = value;
	}

	public void setOutputName_7_1_9(Float value) {
		this.OutputName_7_1_9 = value;
	}
	...
	public void setOutputName_7_1_7(Integer value) {
		this.OutputName_7_1_7 = value;
	}

	public void setOutputName_7_1_6(Integer value) {
