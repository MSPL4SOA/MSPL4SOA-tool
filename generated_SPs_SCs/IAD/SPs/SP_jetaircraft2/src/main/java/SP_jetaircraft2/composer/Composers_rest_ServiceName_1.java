package SP_jetaircraft2.composer;
...
import SP_jetaircraft2.state.State_ServiceName_1_CapabilityName_1_1;
import SP_jetaircraft2.state.State_ServiceName_1_CapabilityName_1_2;
...
public class Composers_rest_ServiceName_1 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_1_1")) {
			...
			in.setInputName_1_1_5((String) source.getParameters()[2]);
			in.setInputName_1_1_3((Integer) source.getParameters()[3]);
			in.setInputName_1_1_4((Float) source.getParameters()[4]);
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_1_CapabilityName_1_1 = (State_ServiceName_1_CapabilityName_1_1) ctx
				.lookup("java:global/SP_jetaircraft2/State_ServiceName_1_CapabilityName_1_1");
		...
		instanceState_ServiceName_1_CapabilityName_1_2 = (State_ServiceName_1_CapabilityName_1_2) ctx
				.lookup("java:global/SP_jetaircraft2/State_ServiceName_1_CapabilityName_1_2");
