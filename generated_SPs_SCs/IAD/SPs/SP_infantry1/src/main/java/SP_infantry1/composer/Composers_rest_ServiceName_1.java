...
public class Composers_rest_ServiceName_1 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_1_5")) {
			...
			in.setInputName_1_5_3((Float) source.getParameters()[0]);
			in.setInputName_1_5_4((String) source.getParameters()[1]);
			in.setInputName_1_5_1((String) source.getParameters()[2]);
			in.setInputName_1_5_2((Float) source.getParameters()[3]);
		...
		if (opName.equals("CapabilityName_1_3")) {
			...
			in.setInputName_1_3_7((Integer) source.getParameters()[0]);
			...
			in.setInputName_1_3_3((String) source.getParameters()[5]);
			in.setInputName_1_3_4((String) source.getParameters()[6]);
			in.setInputName_1_3_1((Integer) source.getParameters()[7]);
			in.setInputName_1_3_2((Integer) source.getParameters()[8]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_1_4")) {
			...
			in.setInputName_1_4_2((String) source.getParameters()[0]);
