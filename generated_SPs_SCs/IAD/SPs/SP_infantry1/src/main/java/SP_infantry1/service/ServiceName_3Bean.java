...
public class ServiceName_3Bean implements ServiceName_3 {
	...
	public OutputDataClassName_3_3 CapabilityName_3_3(
		...
		out.setOutputName_3_3_4(Float.valueOf("404"));

		out.setOutputName_3_3_5(Float.valueOf("561"));

		out.setOutputName_3_3_2(Float.valueOf("436"));

		out.setOutputName_3_3_3("CapabilityName_3_3");

		out.setOutputName_3_3_1(Integer.valueOf("228"));
	...
	public OutputDataClassName_3_5 CapabilityName_3_5(
		...
		out.setOutputName_3_5_2(Integer.valueOf("876"));

		out.setOutputName_3_5_3(Integer.valueOf("700"));

		out.setOutputName_3_5_1(Float.valueOf("677"));
	...
	public OutputDataClassName_3_2 CapabilityName_3_2(
		...
		out.setOutputName_3_2_5(Float.valueOf("185"));

		out.setOutputName_3_2_6(Integer.valueOf("520"));

		out.setOutputName_3_2_3(Float.valueOf("626"));

		out.setOutputName_3_2_4("CapabilityName_3_2");

		out.setOutputName_3_2_1("CapabilityName_3_2");

		out.setOutputName_3_2_2(Integer.valueOf("75"));
