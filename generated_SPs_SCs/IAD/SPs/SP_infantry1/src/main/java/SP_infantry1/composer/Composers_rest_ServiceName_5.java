...
public class Composers_rest_ServiceName_5 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_5_5")) {
			...
			in.setInputName_5_5_7((Float) source.getParameters()[1]);
			in.setInputName_5_5_8((Float) source.getParameters()[2]);
			in.setInputName_5_5_1((String) source.getParameters()[3]);
			in.setInputName_5_5_2((String) source.getParameters()[4]);
			in.setInputName_5_5_5((Float) source.getParameters()[5]);
			in.setInputName_5_5_6((String) source.getParameters()[6]);
			in.setInputName_5_5_3((Float) source.getParameters()[7]);
		...
		if (opName.equals("CapabilityName_5_6")) {
			...
			in.setInputName_5_6_2((Integer) source.getParameters()[1]);
			in.setInputName_5_6_3((Float) source.getParameters()[2]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_2")) {
			...
			in.setInputName_5_2_2((Integer) source.getParameters()[1]);
		...
		if (opName.equals("CapabilityName_5_4")) {
			...
			in.setInputName_5_4_1((Integer) source.getParameters()[1]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_5_CapabilityName_5_6 = (State_ServiceName_5_CapabilityName_5_6) ctx
				.lookup("java:global/SP_infantry1/State_ServiceName_5_CapabilityName_5_6");
