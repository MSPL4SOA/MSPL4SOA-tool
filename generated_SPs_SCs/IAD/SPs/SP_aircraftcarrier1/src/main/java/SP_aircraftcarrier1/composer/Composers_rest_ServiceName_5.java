...
public class Composers_rest_ServiceName_5 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_5_5")) {
			...
			in.setInputName_5_5_9((Float) source.getParameters()[0]);
			in.setInputName_5_5_7((String) source.getParameters()[1]);
			in.setInputName_5_5_8((String) source.getParameters()[2]);
			in.setInputName_5_5_1((Float) source.getParameters()[3]);
			in.setInputName_5_5_2((Integer) source.getParameters()[4]);
			in.setInputName_5_5_5((Integer) source.getParameters()[5]);
			in.setInputName_5_5_6((Float) source.getParameters()[6]);
			in.setInputName_5_5_3((String) source.getParameters()[7]);
			in.setInputName_5_5_4((Float) source.getParameters()[8]);
		...
		if (opName.equals("CapabilityName_5_1")) {
			...
			in.setInputName_5_1_4((String) source.getParameters()[4]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_2")) {
			...
			in.setInputName_5_2_2((Integer) source.getParameters()[2]);
			in.setInputName_5_2_3((Integer) source.getParameters()[3]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_5_3")) {
			...
			in.setInputName_5_3_3((Integer) source.getParameters()[1]);
			in.setInputName_5_3_4((Float) source.getParameters()[2]);
			in.setInputName_5_3_1((Float) source.getParameters()[3]);
			in.setInputName_5_3_2((Float) source.getParameters()[4]);
			in.setInputName_5_3_7((String) source.getParameters()[5]);
			in.setInputName_5_3_8((Float) source.getParameters()[6]);
			in.setInputName_5_3_5((String) source.getParameters()[7]);
