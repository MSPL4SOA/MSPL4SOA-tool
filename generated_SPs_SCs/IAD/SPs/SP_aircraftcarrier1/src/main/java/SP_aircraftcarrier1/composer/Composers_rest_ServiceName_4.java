...
public class Composers_rest_ServiceName_4 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_4_4")) {
			...
			in.setInputName_4_4_6((Float) source.getParameters()[1]);
			in.setInputName_4_4_7((String) source.getParameters()[2]);
			in.setInputName_4_4_1((String) source.getParameters()[3]);
			in.setInputName_4_4_2((Float) source.getParameters()[4]);
			in.setInputName_4_4_3((String) source.getParameters()[5]);
			in.setInputName_4_4_4((Float) source.getParameters()[6]);
			message.setContent(in);
		}
