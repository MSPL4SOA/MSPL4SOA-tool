 ...
 * 2017-03-24T23:28:21.295+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_3", wsdlLocation = "http://localhost:8080/SP_aircraftcarrier1/ServiceName_3/ServiceName_3?wsdl", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0")
public class ServiceName3 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0", "ServiceName_3");
	...
	static {
		...
		try {
			url = new URL(
					"http://localhost:8080/SP_aircraftcarrier1/ServiceName_3/ServiceName_3?wsdl");
