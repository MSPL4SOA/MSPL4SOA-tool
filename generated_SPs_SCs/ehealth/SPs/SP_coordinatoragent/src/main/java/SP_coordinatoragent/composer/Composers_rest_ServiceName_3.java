...
public class Composers_rest_ServiceName_3 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_3_4")) {
			...
			in.setInputName_3_4_3((Integer) source.getParameters()[2]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_5")) {
			...
			in.setInputName_3_5_1((Integer) source.getParameters()[1]);
			in.setInputName_3_5_2((Integer) source.getParameters()[2]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_6")) {
			...
			in.setInputName_3_6_6((Integer) source.getParameters()[0]);
			in.setInputName_3_6_7((String) source.getParameters()[1]);
			in.setInputName_3_6_4((Float) source.getParameters()[2]);
			in.setInputName_3_6_5((String) source.getParameters()[3]);
			in.setInputName_3_6_2((Float) source.getParameters()[4]);
			in.setInputName_3_6_3((String) source.getParameters()[5]);
			in.setInputName_3_6_1((Integer) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_1")) {
			...
			in.setInputName_3_1_1((Float) source.getParameters()[1]);
			in.setInputName_3_1_2((Integer) source.getParameters()[2]);
			message.setContent(in);
		}
