...
public class Composers_rest_ServiceName_4 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_4_2")) {
			...
			in.setInputName_4_2_1((Integer) source.getParameters()[2]);
		...
		if (opName.equals("CapabilityName_4_3")) {
			...
			in.setInputName_4_3_7((Float) source.getParameters()[1]);
			in.setInputName_4_3_8((String) source.getParameters()[2]);
			...
			in.setInputName_4_3_4((String) source.getParameters()[6]);
			in.setInputName_4_3_5((Integer) source.getParameters()[7]);
			in.setInputName_4_3_1((Float) source.getParameters()[8]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_4")) {
			...
			in.setInputName_4_4_2((Float) source.getParameters()[2]);
		...
		if (opName.equals("CapabilityName_4_5")) {
			...
			in.setInputName_4_5_8((String) source.getParameters()[0]);
			in.setInputName_4_5_9((String) source.getParameters()[1]);
			in.setInputName_4_5_4((String) source.getParameters()[2]);
			in.setInputName_4_5_5((String) source.getParameters()[3]);
			in.setInputName_4_5_6((String) source.getParameters()[4]);
			in.setInputName_4_5_7((Float) source.getParameters()[5]);
			in.setInputName_4_5_1((Float) source.getParameters()[6]);
			in.setInputName_4_5_2((Integer) source.getParameters()[7]);
			in.setInputName_4_5_3((Integer) source.getParameters()[8]);
			message.setContent(in);
		}
