...
@XmlType(name = "inputDataClassName_3_1", propOrder = { "InputName_3_1_3",
		...
		"InputName_3_1_9", "InputName_3_1_7", "InputName_3_1_8",
		"InputName_3_1_5", "InputName_3_1_6" })
public class InputDataClassName_3_1 implements Serializable {
	...
	@XmlElement(name = "InputName_3_1_9")
	protected String InputName_3_1_9;
	@XmlElement(name = "InputName_3_1_7")
	protected String InputName_3_1_7;
	@XmlElement(name = "InputName_3_1_8")
	protected String InputName_3_1_8;
	@XmlElement(name = "InputName_3_1_5")
	protected Float InputName_3_1_5;
	@XmlElement(name = "InputName_3_1_6")
	protected String InputName_3_1_6;
	...
	public String getInputName_3_1_9() {
		return InputName_3_1_9;
	}

	public String getInputName_3_1_7() {
		return InputName_3_1_7;
	}

	public String getInputName_3_1_8() {
	...
	public String getInputName_3_1_6() {
	...
	public void setInputName_3_1_9(String value) {
		this.InputName_3_1_9 = value;
	}

	public void setInputName_3_1_7(String value) {
		this.InputName_3_1_7 = value;
	}

	public void setInputName_3_1_8(String value) {
	...
	public void setInputName_3_1_6(String value) {
