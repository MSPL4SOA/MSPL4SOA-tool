...
public class Composers_rest_ServiceName_1 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_1_5")) {
			...
			in.setInputName_1_5_5((String) source.getParameters()[0]);
			...
			in.setInputName_1_5_7((Float) source.getParameters()[4]);
			in.setInputName_1_5_1((Float) source.getParameters()[5]);
			in.setInputName_1_5_2((Integer) source.getParameters()[6]);
		...
		if (opName.equals("CapabilityName_1_2")) {
			...
			in.setInputName_1_2_2((String) source.getParameters()[2]);
			in.setInputName_1_2_3((Float) source.getParameters()[3]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_1_3")) {
			...
			in.setInputName_1_3_1((Integer) source.getParameters()[0]);
		...
		if (opName.equals("CapabilityName_1_4")) {
			...
			in.setInputName_1_4_2((Float) source.getParameters()[0]);
			in.setInputName_1_4_3((Float) source.getParameters()[1]);
			in.setInputName_1_4_1((String) source.getParameters()[2]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_1_CapabilityName_1_1 = (State_ServiceName_1_CapabilityName_1_1) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_1_CapabilityName_1_1");
		...
		instanceState_ServiceName_1_CapabilityName_1_2 = (State_ServiceName_1_CapabilityName_1_2) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_1_CapabilityName_1_2");
		...
		instanceState_ServiceName_1_CapabilityName_1_3 = (State_ServiceName_1_CapabilityName_1_3) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_1_CapabilityName_1_3");
		...
		instanceState_ServiceName_1_CapabilityName_1_4 = (State_ServiceName_1_CapabilityName_1_4) ctx
				.lookup("java:global/SP_helicopter1/State_ServiceName_1_CapabilityName_1_4");
