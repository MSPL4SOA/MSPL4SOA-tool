...
@XmlType(name = "inputDataClassName_3_5", propOrder = { "InputName_3_5_5",
		"InputName_3_5_6", "InputName_3_5_3", "InputName_3_5_4",
		"InputName_3_5_1", "InputName_3_5_2" })
public class InputDataClassName_3_5 implements Serializable {

	private static final long serialVersionUID = 1L;

	@XmlElement(name = "InputName_3_5_5")
	protected Float InputName_3_5_5;
	@XmlElement(name = "InputName_3_5_6")
	protected Float InputName_3_5_6;
	...
	public Float getInputName_3_5_5() {
		return InputName_3_5_5;
	}

	public Float getInputName_3_5_6() {
	...
	public void setInputName_3_5_5(Float value) {
		this.InputName_3_5_5 = value;
	}

	public void setInputName_3_5_6(Float value) {
