...
public class Composers_rest_ServiceName_1 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_1_5")) {
			...
			in.setInputName_1_5_5((Integer) source.getParameters()[0]);
			in.setInputName_1_5_6((Float) source.getParameters()[1]);
			in.setInputName_1_5_3((Integer) source.getParameters()[2]);
			in.setInputName_1_5_4((Float) source.getParameters()[3]);
			in.setInputName_1_5_9((Float) source.getParameters()[4]);
			in.setInputName_1_5_7((String) source.getParameters()[5]);
			in.setInputName_1_5_8((Integer) source.getParameters()[6]);
			in.setInputName_1_5_1((String) source.getParameters()[7]);
			in.setInputName_1_5_2((Float) source.getParameters()[8]);
		...
		if (opName.equals("CapabilityName_1_1")) {
			...
			in.setInputName_1_1_6((String) source.getParameters()[3]);
			in.setInputName_1_1_3((Integer) source.getParameters()[4]);
		...
		if (opName.equals("CapabilityName_1_3")) {
			...
			in.setInputName_1_3_7((String) source.getParameters()[0]);
			...
			in.setInputName_1_3_1((Float) source.getParameters()[6]);
		...
		if (opName.equals("CapabilityName_1_4")) {
			...
			in.setInputName_1_4_2((Integer) source.getParameters()[4]);
			in.setInputName_1_4_3((String) source.getParameters()[5]);
			in.setInputName_1_4_1((String) source.getParameters()[6]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_1_CapabilityName_1_5 = (State_ServiceName_1_CapabilityName_1_5) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_1_CapabilityName_1_5");
		...
		instanceState_ServiceName_1_CapabilityName_1_1 = (State_ServiceName_1_CapabilityName_1_1) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_1_CapabilityName_1_1");
		...
		instanceState_ServiceName_1_CapabilityName_1_2 = (State_ServiceName_1_CapabilityName_1_2) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_1_CapabilityName_1_2");
		...
		instanceState_ServiceName_1_CapabilityName_1_3 = (State_ServiceName_1_CapabilityName_1_3) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_1_CapabilityName_1_3");
		...
		instanceState_ServiceName_1_CapabilityName_1_4 = (State_ServiceName_1_CapabilityName_1_4) ctx
				.lookup("java:global/SP_aircraftcarrier1/State_ServiceName_1_CapabilityName_1_4");
