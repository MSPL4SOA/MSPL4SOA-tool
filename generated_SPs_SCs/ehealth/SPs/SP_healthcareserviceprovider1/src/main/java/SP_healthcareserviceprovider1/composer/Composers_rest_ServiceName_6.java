...
public class Composers_rest_ServiceName_6 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_6_4")) {
			...
			in.setInputName_6_4_4((Float) source.getParameters()[3]);
		...
		if (opName.equals("CapabilityName_6_5")) {
			...
			in.setInputName_6_5_3((Float) source.getParameters()[2]);
			in.setInputName_6_5_4((Float) source.getParameters()[3]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_6_1")) {
			...
			in.setInputName_6_1_1((String) source.getParameters()[1]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_6_2")) {
			...
			in.setInputName_6_2_9((Integer) source.getParameters()[0]);
			in.setInputName_6_2_1((Integer) source.getParameters()[1]);
			in.setInputName_6_2_2((Float) source.getParameters()[2]);
			in.setInputName_6_2_3((String) source.getParameters()[3]);
			in.setInputName_6_2_4((Integer) source.getParameters()[4]);
			in.setInputName_6_2_5((String) source.getParameters()[5]);
			in.setInputName_6_2_6((String) source.getParameters()[6]);
			in.setInputName_6_2_7((Integer) source.getParameters()[7]);
			in.setInputName_6_2_8((Float) source.getParameters()[8]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_6_3")) {
			...
			in.setInputName_6_3_1((Float) source.getParameters()[2]);
			in.setInputName_6_3_2((String) source.getParameters()[3]);
			in.setInputName_6_3_3((String) source.getParameters()[4]);
			in.setInputName_6_3_4((Integer) source.getParameters()[5]);
			in.setInputName_6_3_5((String) source.getParameters()[6]);
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_6_CapabilityName_6_4 = (State_ServiceName_6_CapabilityName_6_4) ctx
				.lookup("java:global/SP_infantry1/State_ServiceName_6_CapabilityName_6_4");
		...
		instanceState_ServiceName_6_CapabilityName_6_5 = (State_ServiceName_6_CapabilityName_6_5) ctx
				.lookup("java:global/SP_infantry1/State_ServiceName_6_CapabilityName_6_5");
		...
		instanceState_ServiceName_6_CapabilityName_6_2 = (State_ServiceName_6_CapabilityName_6_2) ctx
				.lookup("java:global/SP_infantry1/State_ServiceName_6_CapabilityName_6_2");
		...
		instanceState_ServiceName_6_CapabilityName_6_3 = (State_ServiceName_6_CapabilityName_6_3) ctx
				.lookup("java:global/SP_infantry1/State_ServiceName_6_CapabilityName_6_3");
