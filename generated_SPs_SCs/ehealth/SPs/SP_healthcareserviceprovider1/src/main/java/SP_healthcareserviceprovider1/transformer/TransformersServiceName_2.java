...
public final class TransformersServiceName_2 {
	...
	@Transformer(from = "{urn:SP_infantry1:SP_infantry1:1.0}CapabilityName_2_4")
	...
	public InputDataClassName_2_5 transformCapabilityName_2_5ToInputDataClassName_2_5(
		...
		in.setInputName_2_5_2(Integer.valueOf(XMLSOAPTransformers
	...
	@Transformer(to = "{urn:SP_infantry1:SP_infantry1:1.0}CapabilityName_2_1Response")
	public Element transformOutputDataClassName_2_1ToCapabilityName_2_1Response(
			OutputDataClassName_2_1 from) {

		StringBuffer resultXml = new StringBuffer()
				.append("<OutputDataClassName_2_1:CapabilityName_2_1Response xmlns:OutputDataClassName_2_1=\"urn:SP_infantry1:SP_infantry1:1.0\">")
				.append("<return>")
