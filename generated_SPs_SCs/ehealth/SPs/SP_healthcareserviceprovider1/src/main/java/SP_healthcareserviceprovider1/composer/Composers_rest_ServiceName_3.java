...
public class Composers_rest_ServiceName_3 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_3_3")) {
			...
			in.setInputName_3_3_7((String) source.getParameters()[2]);
			in.setInputName_3_3_8((String) source.getParameters()[3]);
			in.setInputName_3_3_5((Integer) source.getParameters()[4]);
			in.setInputName_3_3_6((Integer) source.getParameters()[5]);
			in.setInputName_3_3_3((String) source.getParameters()[6]);
			in.setInputName_3_3_4((Integer) source.getParameters()[7]);
		...
		if (opName.equals("CapabilityName_3_4")) {
			...
			in.setInputName_3_4_6((Float) source.getParameters()[2]);
			in.setInputName_3_4_7((String) source.getParameters()[3]);
			in.setInputName_3_4_4((Float) source.getParameters()[4]);
			in.setInputName_3_4_5((Integer) source.getParameters()[5]);
			in.setInputName_3_4_2((Integer) source.getParameters()[6]);
			in.setInputName_3_4_3((Float) source.getParameters()[7]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_3_5")) {
			...
			in.setInputName_3_5_5((String) source.getParameters()[0]);
			in.setInputName_3_5_6((Integer) source.getParameters()[1]);
			in.setInputName_3_5_3((Float) source.getParameters()[2]);
			in.setInputName_3_5_4((Float) source.getParameters()[3]);
			in.setInputName_3_5_1((Integer) source.getParameters()[4]);
			in.setInputName_3_5_2((Float) source.getParameters()[5]);
			message.setContent(in);
		}
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_3_CapabilityName_3_1 = (State_ServiceName_3_CapabilityName_3_1) ctx
				.lookup("java:global/SP_infantry1/State_ServiceName_3_CapabilityName_3_1");
