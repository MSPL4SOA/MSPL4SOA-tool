 ...
 * 2017-03-24T23:28:21.024+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_4", wsdlLocation = "http://localhost:8080/SP_aircraftcarrier1/ServiceName_4/ServiceName_4?wsdl", targetNamespace = "urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0")
public class ServiceName4 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:SP_aircraftcarrier1:SP_aircraftcarrier1:1.0", "ServiceName_4");
	...
	static {
		...
		try {
			url = new URL(
					"http://localhost:8080/SP_aircraftcarrier1/ServiceName_4/ServiceName_4?wsdl");
