...
public class Composers_rest_ServiceName_3 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_3_6")) {
			...
			in.setInputName_3_6_6((String) source.getParameters()[1]);
			in.setInputName_3_6_7((Float) source.getParameters()[2]);
			in.setInputName_3_6_4((Float) source.getParameters()[3]);
			in.setInputName_3_6_5((String) source.getParameters()[4]);
			in.setInputName_3_6_2((Integer) source.getParameters()[5]);
		...
		if (opName.equals("CapabilityName_3_1")) {
			...
			in.setInputName_3_1_1((String) source.getParameters()[1]);
			in.setInputName_3_1_2((String) source.getParameters()[2]);
			message.setContent(in);
		}
