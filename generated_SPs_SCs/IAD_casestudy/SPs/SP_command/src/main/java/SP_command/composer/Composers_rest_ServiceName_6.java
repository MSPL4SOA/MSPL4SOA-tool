...
public class Composers_rest_ServiceName_6 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_6_1")) {
			...
			in.setInputName_6_1_1((String) source.getParameters()[3]);
		...
		if (opName.equals("CapabilityName_6_2")) {
			...
			in.setInputName_6_2_8((Integer) source.getParameters()[7]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_6_3")) {
			...
			in.setInputName_6_3_1((String) source.getParameters()[0]);
			in.setInputName_6_3_2((Float) source.getParameters()[1]);
