...
@XmlType(name = "outputDataClassName_4_4", propOrder = { "OutputName_4_4_2",
		...
		"OutputName_4_4_6", "OutputName_4_4_7", "OutputName_4_4_8",
		"OutputName_4_4_9", "OutputName_4_4_1" })
public class OutputDataClassName_4_4 implements Serializable {
	...
	protected Integer OutputName_4_4_5;
	@XmlElement(name = "OutputName_4_4_6")
	protected Float OutputName_4_4_6;
	@XmlElement(name = "OutputName_4_4_7")
	protected Integer OutputName_4_4_7;
	@XmlElement(name = "OutputName_4_4_8")
	protected String OutputName_4_4_8;
	@XmlElement(name = "OutputName_4_4_9")
	protected Float OutputName_4_4_9;
	...
	public Integer getOutputName_4_4_5() {
		return OutputName_4_4_5;
	}

	public Float getOutputName_4_4_6() {
		return OutputName_4_4_6;
	}

	public Integer getOutputName_4_4_7() {
		return OutputName_4_4_7;
	}

	public String getOutputName_4_4_8() {
		return OutputName_4_4_8;
	}

	public Float getOutputName_4_4_9() {
		return OutputName_4_4_9;
	}
	...
	public void setOutputName_4_4_5(Integer value) {
		this.OutputName_4_4_5 = value;
	}

	public void setOutputName_4_4_6(Float value) {
		this.OutputName_4_4_6 = value;
	}

	public void setOutputName_4_4_7(Integer value) {
		this.OutputName_4_4_7 = value;
	}

	public void setOutputName_4_4_8(String value) {
		this.OutputName_4_4_8 = value;
	}

	public void setOutputName_4_4_9(Float value) {
		this.OutputName_4_4_9 = value;
	}
