...
public class Composers_rest_ServiceName_1 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_1_1")) {
			...
			in.setInputName_1_1_3((Integer) source.getParameters()[2]);
		...
		if (opName.equals("CapabilityName_1_3")) {
			...
			in.setInputName_1_3_5((String) source.getParameters()[0]);
			in.setInputName_1_3_3((Integer) source.getParameters()[1]);
			in.setInputName_1_3_4((Integer) source.getParameters()[2]);
			in.setInputName_1_3_1((Float) source.getParameters()[3]);
			in.setInputName_1_3_2((Float) source.getParameters()[4]);
			message.setContent(in);
		}
