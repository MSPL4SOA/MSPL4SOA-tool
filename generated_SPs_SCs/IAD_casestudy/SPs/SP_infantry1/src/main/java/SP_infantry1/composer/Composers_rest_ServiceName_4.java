...
public class Composers_rest_ServiceName_4 extends RESTEasyMessageComposer {
	...
	public Message compose(RESTEasyBindingData source, Exchange exchange)
		...
		if (opName.equals("CapabilityName_4_4")) {
			...
			in.setInputName_4_4_7((Integer) source.getParameters()[2]);
			in.setInputName_4_4_1((String) source.getParameters()[3]);
			in.setInputName_4_4_2((String) source.getParameters()[4]);
			in.setInputName_4_4_3((Float) source.getParameters()[5]);
			in.setInputName_4_4_4((Integer) source.getParameters()[6]);
			message.setContent(in);
		}
		...
		if (opName.equals("CapabilityName_4_1")) {
			...
			in.setInputName_4_1_1((String) source.getParameters()[1]);
			in.setInputName_4_1_2((String) source.getParameters()[2]);
	...
	public RESTEasyBindingData decompose(Exchange exchange,
		...
		instanceState_ServiceName_4_CapabilityName_4_3 = (State_ServiceName_4_CapabilityName_4_3) ctx
				.lookup("java:global/SP_infantry1/State_ServiceName_4_CapabilityName_4_3");
