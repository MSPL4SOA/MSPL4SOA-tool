 ...
 * 2016-08-25T16:25:17.419+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_1", wsdlLocation = "http://localhost:8080/sp_manager/ServiceName_1/ServiceName_1?wsdl", targetNamespace = "urn:sp_manager:sp_manager:1.0")
public class ServiceName1 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_1");
	public final static QName ServiceName1Port = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_1Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/sp_manager/ServiceName_1/ServiceName_1?wsdl");
