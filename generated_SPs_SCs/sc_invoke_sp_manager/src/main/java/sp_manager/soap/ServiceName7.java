 ...
 * 2016-08-25T16:25:19.883+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_7", wsdlLocation = "http://localhost:8080/sp_manager/ServiceName_7/ServiceName_7?wsdl", targetNamespace = "urn:sp_manager:sp_manager:1.0")
public class ServiceName7 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_7");
	public final static QName ServiceName7Port = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_7Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/sp_manager/ServiceName_7/ServiceName_7?wsdl");
