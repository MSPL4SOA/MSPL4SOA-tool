 ...
 * 2016-08-25T16:25:18.027+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_3", wsdlLocation = "http://localhost:8080/sp_manager/ServiceName_3/ServiceName_3?wsdl", targetNamespace = "urn:sp_manager:sp_manager:1.0")
public class ServiceName3 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_3");
	public final static QName ServiceName3Port = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_3Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/sp_manager/ServiceName_3/ServiceName_3?wsdl");
