 ...
 * 2016-08-25T16:25:17.707+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_2", wsdlLocation = "http://localhost:8080/sp_manager/ServiceName_2/ServiceName_2?wsdl", targetNamespace = "urn:sp_manager:sp_manager:1.0")
public class ServiceName2 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_2");
	public final static QName ServiceName2Port = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_2Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/sp_manager/ServiceName_2/ServiceName_2?wsdl");
