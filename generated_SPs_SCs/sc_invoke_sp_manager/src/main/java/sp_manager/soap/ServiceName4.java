 ...
 * 2016-08-25T16:25:19.201+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_4", wsdlLocation = "http://localhost:8080/sp_manager/ServiceName_4/ServiceName_4?wsdl", targetNamespace = "urn:sp_manager:sp_manager:1.0")
public class ServiceName4 extends Service {

	public final static URL WSDL_LOCATION;

	public final static QName SERVICE = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_4");
	public final static QName ServiceName4Port = new QName(
			"urn:sp_manager:sp_manager:1.0", "ServiceName_4Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/sp_manager/ServiceName_4/ServiceName_4?wsdl");
