 ...
 * 2016-08-25T23:11:11.661+01:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "ServiceName_1", wsdlLocation = "http://localhost:8080/a1/ServiceName_1/ServiceName_1?wsdl", targetNamespace = "urn:a1:a1:1.0")
public class ServiceName1 extends Service {
	...
	public final static QName SERVICE = new QName("urn:a1:a1:1.0",
			"ServiceName_1");
	public final static QName ServiceName1Port = new QName("urn:a1:a1:1.0",
			"ServiceName_1Port");
	static {
		URL url = null;
		try {
			url = new URL(
					"http://localhost:8080/a1/ServiceName_1/ServiceName_1?wsdl");
